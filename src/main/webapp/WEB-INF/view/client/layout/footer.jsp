    <%@page contentType="text/html" pageEncoding="UTF-8" %>
        ...
        <h1 class="text-primary mb-0">CleanFruits</h1>
        <p class="text-secondary mb-0">tulat2002@gmail.com</p>
        </a>
        </div>
        </div>
        </div>
        ...
        <p>Author:AnkTu</p>
        <p>Website: <a href="/" target="_blank"> CleanFruits</a></p>
        </div>
        </div>
        </div>
        </div>
        ...
        class="fas fa-copyright text-light me-2"></i>CleanFruits</a>, Cam kết tất cả sản phẩm đều là hàng tươi mới.</span>
        </div>
